...
class EnvConfig {
    ...
    // Railway usa MONGODB_URL, otros servicios pueden usar MONGODB_URI
    static MONGODB_URI = process.env.MONGODB_URI || process.env.MONGODB_URL || process.env.MONGO_URL || process.env.MONGO_PUBLIC_URL;
