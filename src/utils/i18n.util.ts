...
export const TRANSLATIONS = {
    es: {
        ...
        commands: {
            onboard: {
                description: "Obtener video de introducción para entender cómo funciona el bot",
                example: "onboard"
            },
            help: {
                description: "Obtener descripción de comandos",
                example: "help ping"
            },
            ping: {
            ...
            langlist: {
                description: "Obtener lista de idiomas disponibles",
                example: "langlist"
            },
            translate: {
            ...
            meme: {
                description: "Obtener meme aleatorio",
                example: "meme"
            },
            joke: {
                description: "Obtener chiste aleatorio",
                example: "joke"
            },
            get: {
                description: "Descargar archivo desde redes sociales (TikTok, Instagram, Twitter, Facebook, LinkedIn)",
            ...
            ticket: {
                description: "Gestión de tickets de soporte IT",
                example: "ticket create pos El POS no imprime"
            }
        },

        helpHeader: "Lista de comandos disponibles:",
        helpFooter: "(Para ejecutar un comando, inicia con el prefijo {prefix})",

        getMessages: {
            invalidUrl: "Por favor proporciona una URL válida para el video.",
            unsupportedNetwork: "Red social no soportada.",
            downloading: "Obteniendo tu archivo desde {network} (Tamaño máximo permitido {size} MB)...",
            downloadError: "Error durante la descarga del archivo.",
        ...
        onboardMessages: {
            caption: "¡Bienvenido a {botName}! \n\nMira el video de introducción para entender cómo funciona el bot.",
            pleaseHelp: "Para obtener ayuda, escribe {prefix}help"
        }
    },
    fr: {
        ...
        commands: {
            ...
            ticket: {
                description: "Gestion des tickets de support IT",
                example: "ticket create pos Le POS n'imprime pas"
            }
        },
    ...
    en: {
        ...
        commands: {
            ...
            ticket: {
                ...
                example: "ticket create pos POS not printing"
            }
        },
...
export function translate(language: string, key: string, params: Record<string, string> = {}): string {
    const translations = TRANSLATIONS[language] || TRANSLATIONS['es'];
...
export class UserI18n {
    ...
    random(key: string, params: Record<string, string> = {}): string {
        const translations = TRANSLATIONS[this.language] || TRANSLATIONS['es'];
