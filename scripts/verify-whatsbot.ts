...
/**
 * Script de verificación para WhatsBot IT
...
class WhatsBotITVerifier {
    ...
    static async verifyGeminiAPI(): Promise<VerificationResult> {
        try {
            ...
            const result = await model.generateContent("Hola WhatsBot IT, ¿cómo estás?");
    ...
    static async runVerification(): Promise<void> {
        console.log("🧠 Verificando configuración de WhatsBot IT...\n");
        ...
        if (successCount === totalCount) {
            console.log("\n🎉 ¡WhatsBot IT está listo para funcionar!");
...
if (require.main === module) {
    WhatsBotITVerifier.runVerification().catch(console.error);
}

export default WhatsBotITVerifier;
